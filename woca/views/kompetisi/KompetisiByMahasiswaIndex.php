...
?>
    ...
    <div class="kompetisi-index">
        ...
        <p class="marginp">
            ...
            <?= Html::a('Tambah Kompetisi', ['kompetisi/kompetisi-by-mahasiswa-add'], ['class' => 'btn btn-success r']) ?>
                            ...
                            'columns' => [
                                ...
                                [
                                    ...
                                    'value' => function($model){
                                        ...
                                        return Html::a($result, ['kompetisi/download-mahasiswa', 'id'=>$model->kompetisi_id]);
                                    },

                                ],
                                ['class' => 'common\components\ToolsColumn',
                                    'template' => '{view} {cancel} {edit}',
                                    'header' => 'Aksi',
                                    ...
                                    'urlCreator' => function ($action, $data, $key, $index){
                                        ...
                                        if ($action === 'view') {
                                            return Url::toRoute(['kompetisi-by-mahasiswa-view', 'id' => $data->kompetisi_id]);
                                        }else if ($action === 'edit') {
                                            return Url::toRoute(['kompetisi-by-mahasiswa-edit', 'id' => $data->kompetisi_id]);
                                        }else if ($action === 'cancel') {
                                            return Url::toRoute(['cancel-by-mahasiswa', 'id' => $data->kompetisi_id]);
                                        }
                                    }
                                ],
